          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Take a quick fitness assessment to understand your current
                      fitness level and set realistic goals.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Discover a variety of calisthenics workouts tailored to
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Based on your assessment results and workout preferences,
                      create a personalized calisthenics plan.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Track Your Progress</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Use the tracking tools to monitor your progress, adjust
                      your plan, and stay motivated on your calisthenics
                      journey.
                    </span>
                  </Fragment>
                )}
