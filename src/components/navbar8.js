          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text12">Questionnaire</span>
                  </Fragment>
                )}
              </a>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text17">
                                  Welcome to the Calisthenics website where you
                                  can start your fitness journey!
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Login to access personalized workout plans and
                                  track your progress.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text20">
                                  Complete the questionnaire to receive
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text17">
                            Welcome to the Calisthenics website where you can
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text25">
                            Login to access personalized workout plans and track
                            your progress.
                          </span>
                        </Fragment>
                      )}
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text21">Questionnaire</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text20">
                            Complete the questionnaire to receive customized
...
Navbar8.defaultProps = {
  ...
  link3: undefined,
  page2: undefined,
  page3ImageAlt: 'Image showing a questionnaire form',
  link2: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1704374810187-154ccc66798f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDc4MzcxOXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1676223020538-1cb6ce562a4a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDc4MzcxOXw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  ...
  page4ImageAlt: '',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1578323757901-01ee4fc29f61?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDc4MzcxOXw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
  link1: undefined,
  link4: undefined,
  logoAlt: 'Calisthenics Logo',
  link1Url: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1715227200034-536f1ea86dcf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczNDc4MzcxOHw&ixlib=rb-4.0.3&q=80&w=1080',
  page4: undefined,
  link3Url: 'https://www.teleporthq.io',
  linkUrlPage2: 'https://www.teleporthq.io',
  page1ImageAlt: 'Image depicting people doing calisthenics exercises',
  page2ImageAlt: 'Image of a person logging into the website',
